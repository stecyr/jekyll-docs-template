...
Référence du "Server API" d'OSRM "OSRM":https://github.com/DennisOSRM/Project-OSRM/wiki/Server-api.

**1. viaroute (Calcul du chemin le plus court entre deux coordonnées et d'une liste ordonnée de point intermédiaire.)**
...
> spssogl97d.sso.msp.gouv.qc.ca:5000/nearest?loc=47.131324,-72.220945
   ...
   Les coordonnées des points sont dans le système géographique (4326)
   La réponse aura l'air de ceci:
